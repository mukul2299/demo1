...
class RestaurantTest {
    Restaurant restaurant ;//= new Restaurant("Behroz","pune", LocalTime.parse("08:59:59"), LocalTime.parse("23:59:59"));
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time() throws restaurantNotFoundException {
        ...
        assertTrue(restaurantService.findRestaurantByName(searchedRestaurantName).isRestaurantOpen());
